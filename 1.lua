...
cpp_SetNextScript("./2.lua")

--Set heli initial position
cpp_SetHeliInitialPosition(256.000000, 243.000000)
...
cpp_AddTile(0, 1408, 512)

cpp_AddTile(0, 1408, 576)
...
cpp_AddTile(1, 1920, 768)

cpp_AddTile(1, 1344, 1536)

cpp_AddTile(1, 1728, 448)

cpp_AddTile(1, 1600, 320)
...
cpp_AddTile(1, 1792, 1152)

cpp_AddTile(1, 1408, 64)

cpp_AddTile(1, 1984, 768)
...
cpp_AddTile(1, 1728, 1216)

cpp_AddTile(1, 2496, 1472)

cpp_AddTile(1, 1920, 896)

cpp_AddTile(1, 2624, 64)

cpp_AddTile(1, 1856, 1024)

cpp_AddTile(1, 1856, 1088)

cpp_AddTile(1, 1920, 960)

cpp_AddTile(1, 2496, 320)

cpp_AddTile(1, 1664, 320)

cpp_AddTile(1, 1856, 512)
...
cpp_AddTile(1, 1664, 384)

cpp_AddTile(1, 1792, 1088)
...
cpp_AddTile(1, 1792, 512)

cpp_AddTile(1, 1856, 576)

cpp_AddTile(1, 2560, 640)

cpp_AddTile(1, 1408, 128)

cpp_AddTile(1, 1728, 384)

cpp_AddTile(1, 1536, 1344)

cpp_AddTile(1, 2560, 256)

cpp_AddTile(1, 1792, 448)

cpp_AddTile(1, 2560, 320)

cpp_AddTile(1, 2496, 256)

cpp_AddTile(1, 1600, 256)

cpp_AddTile(1, 2496, 576)

cpp_AddTile(1, 1984, 640)

cpp_AddTile(1, 1472, 192)
...
cpp_AddTile(1, 1920, 640)

cpp_AddTile(1, 2624, 320)

cpp_AddTile(1, 2560, 1216)

cpp_AddTile(1, 1920, 1024)
...
cpp_AddTile(1, 1728, 1152)

cpp_AddTile(1, 1984, 960)
...
cpp_AddTile(1, 1536, 192)

cpp_AddTile(1, 2496, 1024)

cpp_AddTile(1, 1536, 256)
...
cpp_AddTile(1, 1920, 576)

cpp_AddTile(1, 2624, 1408)

cpp_AddTile(2, 1600, 128)

cpp_AddTile(2, 1792, 320)

cpp_AddTile(2, 1664, 192)

cpp_AddTile(2, 1472, 0)

cpp_AddTile(2, 2048, 576)

cpp_AddTile(2, 1536, 64)

cpp_AddTile(2, 1856, 384)

cpp_AddTile(2, 1920, 448)

cpp_AddTile(2, 1728, 256)

cpp_AddTile(2, 1984, 512)

cpp_AddTile(3, 1472, 64)

cpp_AddTile(3, 1920, 512)

cpp_AddTile(3, 1856, 448)

cpp_AddTile(3, 1408, 0)

cpp_AddTile(3, 1792, 384)

cpp_AddTile(3, 1984, 576)

cpp_AddTile(3, 1600, 192)

cpp_AddTile(3, 1728, 320)

cpp_AddTile(3, 1536, 128)

cpp_AddTile(3, 1664, 256)
...
cpp_AddTile(6, 2048, 640)

cpp_AddTile(6, 2048, 960)
...
cpp_AddTile(7, 1472, 256)

cpp_AddTile(7, 1408, 192)

cpp_AddTile(7, 1792, 576)

cpp_AddTile(7, 1728, 512)

cpp_AddTile(7, 1664, 448)

cpp_AddTile(7, 1280, 64)

cpp_AddTile(7, 1536, 320)

cpp_AddTile(7, 1216, 0)

cpp_AddTile(7, 1856, 640)

cpp_AddTile(7, 1600, 384)

cpp_AddTile(7, 1344, 128)

cpp_AddTile(8, 1280, 128)

cpp_AddTile(8, 1664, 512)

cpp_AddTile(8, 1792, 640)

cpp_AddTile(8, 1536, 384)

cpp_AddTile(8, 1408, 256)

cpp_AddTile(8, 1472, 320)

cpp_AddTile(8, 1728, 576)

cpp_AddTile(8, 1216, 64)

cpp_AddTile(8, 1600, 448)

cpp_AddTile(8, 1152, 0)

cpp_AddTile(8, 1344, 192)

cpp_AddTile(9, 1536, 1216)

cpp_AddTile(9, 1472, 1280)

cpp_AddTile(9, 1280, 1472)

cpp_AddTile(9, 1408, 1344)

cpp_AddTile(9, 1664, 1088)
...
cpp_AddTile(9, 1600, 1152)

cpp_AddTile(9, 1728, 1024)

cpp_AddTile(10, 1792, 1024)

cpp_AddTile(10, 1664, 1152)
...
cpp_AddTile(10, 1728, 1088)

cpp_AddTile(10, 1856, 960)

cpp_AddTile(10, 1216, 1600)

cpp_AddTile(10, 1600, 1216)

cpp_AddTile(10, 1536, 1280)

cpp_AddTile(10, 1472, 1344)

cpp_AddTile(11, 1664, 1344)

cpp_AddTile(11, 1792, 1216)

cpp_AddTile(11, 1600, 1408)

cpp_AddTile(11, 1408, 1600)

cpp_AddTile(11, 1728, 1280)

cpp_AddTile(11, 1536, 1472)

cpp_AddTile(11, 1856, 1152)

cpp_AddTile(11, 1984, 1024)

cpp_AddTile(11, 1472, 1536)

cpp_AddTile(11, 1920, 1088)

cpp_AddTile(13, 1600, 1472)

cpp_AddTile(13, 2048, 1024)

cpp_AddTile(13, 1856, 1216)

cpp_AddTile(13, 1792, 1280)

cpp_AddTile(13, 1472, 1600)

cpp_AddTile(13, 1920, 1152)

cpp_AddTile(13, 1664, 1408)

cpp_AddTile(13, 1728, 1344)

cpp_AddTile(13, 1536, 1536)

cpp_AddTile(13, 1984, 1088)
...
cpp_AddTile(15, 2176, 1024)

cpp_AddTile(15, 2176, 960)
...
cpp_AddTile(15, 1536, 576)

cpp_AddTile(15, 1472, 448)

cpp_AddTile(15, 1600, 512)

cpp_AddTile(15, 1792, 768)

cpp_AddTile(15, 1728, 768)

cpp_AddTile(15, 1536, 960)

cpp_AddTile(15, 1472, 960)

cpp_AddTile(15, 1408, 960)

cpp_AddTile(15, 1152, 960)

cpp_AddTile(15, 1088, 960)

cpp_AddTile(15, 960, 960)

cpp_AddTile(15, 896, 960)

cpp_AddTile(15, 704, 960)

cpp_AddTile(15, 640, 896)

cpp_AddTile(15, 512, 960)

cpp_AddTile(15, 832, 768)

cpp_AddTile(15, 896, 768)

cpp_AddTile(15, 1152, 768)

cpp_AddTile(15, 1408, 768)

cpp_AddTile(15, -64, -384)

cpp_AddTile(15, 1216, 576)

cpp_AddTile(15, 1216, 640)

cpp_AddTile(15, 1152, 640)

cpp_AddTile(15, 1088, 640)

cpp_AddTile(15, 1088, 576)

cpp_AddTile(15, 1024, 576)

cpp_AddTile(15, 960, 576)

cpp_AddTile(15, 896, 640)

cpp_AddTile(15, 768, 576)
...
cpp_AddTile(15, 256, 576)

cpp_AddTile(15, 384, 576)
...
AAGUN_29 = 29;
cpp_AddSubGameObject(AAGUN,AAGUN_29,-1,285.000000,801.000000,3.000000)
...
--New Object Definition Script
BASE_26184527 = 26184527;
cpp_AddSubGameObject(BASE,BASE_26184527,-1,3584.000000,801.000000,0.000000)
cpp_SetGameObjectOrientation(BASE_26184527,-4.694791)

cpp_LinkBitmapToID(BASE_26184527,"./images/CONCRETE.PNG")
cpp_SetDamageAmount(26184527,-1);
--New Object Definition Script
BASE_26184528 = 26184528;
cpp_AddSubGameObject(BASE,BASE_26184528,-1,3584.003174,729.000000,0.000000)
cpp_SetGameObjectOrientation(BASE_26184528,-1.570752)

cpp_LinkBitmapToID(BASE_26184528,"./images/CONCRETE.PNG")
cpp_SetDamageAmount(26184528,-1);
--New Object Definition Script
BASE_26184529 = 26184529;
cpp_AddSubGameObject(BASE,BASE_26184529,-1,3584.003174,729.000000,0.000000)
cpp_SetGameObjectOrientation(BASE_26184529,-1.570752)

cpp_LinkBitmapToID(BASE_26184529,"./images/CONCRETE.PNG")
cpp_SetDamageAmount(26184529,-1);
--New Object Definition Script
BASE_26184530 = 26184530;
cpp_AddSubGameObject(BASE,BASE_26184530,-1,3584.003174,729.000000,0.000000)
cpp_SetGameObjectOrientation(BASE_26184530,-1.570752)

cpp_LinkBitmapToID(BASE_26184530,"./images/CONCRETE.PNG")
cpp_SetDamageAmount(26184530,-1);
--New Object Definition Script
BASE_26184531 = 26184531;
cpp_AddSubGameObject(BASE,BASE_26184531,-1,3584.006348,657.000000,0.000000)
cpp_SetGameObjectOrientation(BASE_26184531,-1.570752)

cpp_LinkBitmapToID(BASE_26184531,"./images/CONCRETE.PNG")
cpp_SetDamageAmount(26184531,-1);
--New Object Definition Script
BASE_26184532 = 26184532;
cpp_AddSubGameObject(BASE,BASE_26184532,-1,3584.009521,585.000000,0.000000)
cpp_SetGameObjectOrientation(BASE_26184532,-1.570752)

cpp_LinkBitmapToID(BASE_26184532,"./images/CONCRETE.PNG")
cpp_SetDamageAmount(26184532,-1);
--New Object Definition Script
BASE_26184533 = 26184533;
cpp_AddSubGameObject(BASE,BASE_26184533,-1,3584.012695,513.000000,0.000000)
cpp_SetGameObjectOrientation(BASE_26184533,-1.570752)

cpp_LinkBitmapToID(BASE_26184533,"./images/CONCRETE.PNG")
cpp_SetDamageAmount(26184533,-1);
--New Object Definition Script
BASE_26184534 = 26184534;
cpp_AddSubGameObject(BASE,BASE_26184534,-1,3584.015869,441.000000,0.000000)
cpp_SetGameObjectOrientation(BASE_26184534,-1.570752)

cpp_LinkBitmapToID(BASE_26184534,"./images/CONCRETE.PNG")
cpp_SetDamageAmount(26184534,-1);
--New Object Definition Script
BASE_26184535 = 26184535;
cpp_AddSubGameObject(BASE,BASE_26184535,-1,3367.000000,658.000000,0.000000)
cpp_SetGameObjectOrientation(BASE_26184535,-1.570752)

cpp_LinkBitmapToID(BASE_26184535,"./images/CONCRETE.PNG")
cpp_SetDamageAmount(26184535,-1);
--New Object Definition Script
BASE_26184536 = 26184536;
cpp_AddSubGameObject(BASE,BASE_26184536,-1,3367.003174,586.000000,0.000000)
cpp_SetGameObjectOrientation(BASE_26184536,-1.570752)

cpp_LinkBitmapToID(BASE_26184536,"./images/CONCRETE.PNG")
cpp_SetDamageAmount(26184536,-1);
--New Object Definition Script
BASE_26184537 = 26184537;
cpp_AddSubGameObject(BASE,BASE_26184537,-1,3367.006348,514.000000,0.000000)
cpp_SetGameObjectOrientation(BASE_26184537,-1.570752)

cpp_LinkBitmapToID(BASE_26184537,"./images/CONCRETE.PNG")
cpp_SetDamageAmount(26184537,-1);
--New Object Definition Script
BASE_26184538 = 26184538;
cpp_AddSubGameObject(BASE,BASE_26184538,-1,3367.009521,442.000000,0.000000)
cpp_SetGameObjectOrientation(BASE_26184538,-1.570752)

cpp_LinkBitmapToID(BASE_26184538,"./images/CONCRETE.PNG")
cpp_SetDamageAmount(26184538,-1);
--New Object Definition Script
BASE_26184539 = 26184539;
cpp_AddSubGameObject(BASE,BASE_26184539,-1,3367.012695,370.000000,0.000000)
cpp_SetGameObjectOrientation(BASE_26184539,-1.570752)

cpp_LinkBitmapToID(BASE_26184539,"./images/CONCRETE.PNG")
cpp_SetDamageAmount(26184539,-1);
--New Object Definition Script
BASE_26184540 = 26184540;
cpp_AddSubGameObject(BASE,BASE_26184540,-1,3367.015869,298.000000,0.000000)
cpp_SetGameObjectOrientation(BASE_26184540,-1.570752)

cpp_LinkBitmapToID(BASE_26184540,"./images/CONCRETE.PNG")
cpp_SetDamageAmount(26184540,-1);
--New Object Definition Script
BASE_26184541 = 26184541;
cpp_AddSubGameObject(BASE,BASE_26184541,-1,3367.019043,226.000000,0.000000)
cpp_SetGameObjectOrientation(BASE_26184541,-1.570752)

cpp_LinkBitmapToID(BASE_26184541,"./images/CONCRETE.PNG")
cpp_SetDamageAmount(26184541,-1);
--New Object Definition Script
BASE_26184542 = 26184542;
cpp_AddSubGameObject(BASE,BASE_26184542,-1,3367.022217,154.000000,0.000000)
cpp_SetGameObjectOrientation(BASE_26184542,-1.570752)

cpp_LinkBitmapToID(BASE_26184542,"./images/CONCRETE.PNG")
cpp_SetDamageAmount(26184542,-1);
--New Object Definition Script
...
--New Object Definition Script
BASE_26184544 = 26184544;
cpp_AddSubGameObject(BASE,BASE_26184544,-1,3582.733154,872.988831,0.000000)
cpp_SetGameObjectOrientation(BASE_26184544,-4.694791)

cpp_LinkBitmapToID(BASE_26184544,"./images/CONCRETE.PNG")
cpp_SetDamageAmount(26184544,-1);
--New Object Definition Script
BASE_26184545 = 26184545;
cpp_AddSubGameObject(BASE,BASE_26184545,-1,3581.466309,944.977661,0.000000)
cpp_SetGameObjectOrientation(BASE_26184545,-4.694791)

cpp_LinkBitmapToID(BASE_26184545,"./images/CONCRETE.PNG")
cpp_SetDamageAmount(26184545,-1);
--New Object Definition Script
BASE_26184546 = 26184546;
cpp_AddSubGameObject(BASE,BASE_26184546,-1,3580.199463,1016.966492,0.000000)
cpp_SetGameObjectOrientation(BASE_26184546,-4.694791)

cpp_LinkBitmapToID(BASE_26184546,"./images/CONCRETE.PNG")
cpp_SetDamageAmount(26184546,-1);
--New Object Definition Script
BASE_26184547 = 26184547;
cpp_AddSubGameObject(BASE,BASE_26184547,-1,3578.932617,1088.955322,0.000000)
cpp_SetGameObjectOrientation(BASE_26184547,-4.694791)

cpp_LinkBitmapToID(BASE_26184547,"./images/CONCRETE.PNG")
cpp_SetDamageAmount(26184547,-1);
--New Object Definition Script
BASE_26184548 = 26184548;
cpp_AddSubGameObject(BASE,BASE_26184548,-1,3577.665771,1160.944214,0.000000)
cpp_SetGameObjectOrientation(BASE_26184548,-4.694791)

cpp_LinkBitmapToID(BASE_26184548,"./images/CONCRETE.PNG")
cpp_SetDamageAmount(26184548,-1);
--New Object Definition Script
BASE_26184549 = 26184549;
cpp_AddSubGameObject(BASE,BASE_26184549,-1,3368.000000,938.000000,0.000000)
cpp_SetGameObjectOrientation(BASE_26184549,-4.694791)

cpp_LinkBitmapToID(BASE_26184549,"./images/CONCRETE.PNG")
cpp_SetDamageAmount(26184549,-1);
--New Object Definition Script
BASE_26184550 = 26184550;
cpp_AddSubGameObject(BASE,BASE_26184550,-1,3366.733154,1009.988831,0.000000)
cpp_SetGameObjectOrientation(BASE_26184550,-4.694791)

cpp_LinkBitmapToID(BASE_26184550,"./images/CONCRETE.PNG")
cpp_SetDamageAmount(26184550,-1);
--New Object Definition Script
BASE_26184551 = 26184551;
cpp_AddSubGameObject(BASE,BASE_26184551,-1,3365.466309,1081.977661,0.000000)
cpp_SetGameObjectOrientation(BASE_26184551,-4.694791)

cpp_LinkBitmapToID(BASE_26184551,"./images/CONCRETE.PNG")
cpp_SetDamageAmount(26184551,-1);
--New Object Definition Script
BASE_26184552 = 26184552;
cpp_AddSubGameObject(BASE,BASE_26184552,-1,3364.199463,1153.966553,0.000000)
cpp_SetGameObjectOrientation(BASE_26184552,-4.694791)

cpp_LinkBitmapToID(BASE_26184552,"./images/CONCRETE.PNG")
cpp_SetDamageAmount(26184552,-1);
--New Object Definition Script
BASE_26184553 = 26184553;
cpp_AddSubGameObject(BASE,BASE_26184553,-1,3362.932617,1225.955444,0.000000)
cpp_SetGameObjectOrientation(BASE_26184553,-4.694791)

cpp_LinkBitmapToID(BASE_26184553,"./images/CONCRETE.PNG")
cpp_SetDamageAmount(26184553,-1);
--New Object Definition Script
BASE_26184554 = 26184554;
cpp_AddSubGameObject(BASE,BASE_26184554,-1,3361.665771,1297.944336,0.000000)
cpp_SetGameObjectOrientation(BASE_26184554,-4.694791)

cpp_LinkBitmapToID(BASE_26184554,"./images/CONCRETE.PNG")
cpp_SetDamageAmount(26184554,-1);
--New Object Definition Script
AAGUN_26184555 = 26184555;
cpp_AddSubGameObject(AAGUN,AAGUN_26184555,-1,3661.000000,518.000000,3.000000)
cpp_SetGameObjectOrientation(AAGUN_26184555,0.000000)

cpp_LinkBitmapToID(AAGUN_26184555,"./images/anti aircraft.png")
cpp_SetDamageAmount(26184555,3);
--New Object Definition Script
AAGUN_26184556 = 26184556;
cpp_AddSubGameObject(AAGUN,AAGUN_26184556,-1,3659.000000,652.000000,3.000000)
cpp_SetGameObjectOrientation(AAGUN_26184556,0.000000)

cpp_LinkBitmapToID(AAGUN_26184556,"./images/anti aircraft.png")
cpp_SetDamageAmount(26184556,3);
--New Object Definition Script
AAGUN_26184557 = 26184557;
cpp_AddSubGameObject(AAGUN,AAGUN_26184557,-1,3653.000000,772.000000,3.000000)
cpp_SetGameObjectOrientation(AAGUN_26184557,0.000000)

cpp_LinkBitmapToID(AAGUN_26184557,"./images/anti aircraft.png")
cpp_SetDamageAmount(26184557,3);
--New Object Definition Script
AAGUN_26184558 = 26184558;
cpp_AddSubGameObject(AAGUN,AAGUN_26184558,-1,3652.000000,893.000000,3.000000)
cpp_SetGameObjectOrientation(AAGUN_26184558,0.000000)

cpp_LinkBitmapToID(AAGUN_26184558,"./images/anti aircraft.png")
cpp_SetDamageAmount(26184558,3);
--New Object Definition Script
AAGUN_26184559 = 26184559;
cpp_AddSubGameObject(AAGUN,AAGUN_26184559,-1,3646.000000,1017.000000,3.000000)
cpp_SetGameObjectOrientation(AAGUN_26184559,0.000000)

cpp_LinkBitmapToID(AAGUN_26184559,"./images/anti aircraft.png")
cpp_SetDamageAmount(26184559,3);
--New Object Definition Script
...
--New Object Definition Script
AAGUN_26184570 = 26184570;
cpp_AddSubGameObject(AAGUN,AAGUN_26184570,-1,4433.000000,1192.000000,3.000000)
cpp_SetGameObjectOrientation(AAGUN_26184570,0.000000)

cpp_LinkBitmapToID(AAGUN_26184570,"./images/anti aircraft.png")
cpp_SetDamageAmount(26184570,3);
--New Object Definition Script
BASE_26184571 = 26184571;
cpp_AddSubGameObject(BASE,BASE_26184571,-1,4467.000000,1115.000000,0.000000)
cpp_SetGameObjectOrientation(BASE_26184571,-3.141499)

cpp_LinkBitmapToID(BASE_26184571,"./images/CONCRETE.PNG")
cpp_SetDamageAmount(26184571,-1);
--New Object Definition Script
BASE_26184572 = 26184572;
cpp_AddSubGameObject(BASE,BASE_26184572,-1,4500.000000,1151.000000,0.000000)
cpp_SetGameObjectOrientation(BASE_26184572,-1.570752)

cpp_LinkBitmapToID(BASE_26184572,"./images/CONCRETE.PNG")
cpp_SetDamageAmount(26184572,-1);
--New Object Definition Script
BASE_26184573 = 26184573;
cpp_AddSubGameObject(BASE,BASE_26184573,-1,4395.000000,1114.993286,0.000000)
cpp_SetGameObjectOrientation(BASE_26184573,-3.141499)

cpp_LinkBitmapToID(BASE_26184573,"./images/CONCRETE.PNG")
cpp_SetDamageAmount(26184573,-1);
--New Object Definition Script
BASE_26184574 = 26184574;
cpp_AddSubGameObject(BASE,BASE_26184574,-1,4363.000000,1219.000000,0.000000)
cpp_SetGameObjectOrientation(BASE_26184574,-1.570752)

cpp_LinkBitmapToID(BASE_26184574,"./images/CONCRETE.PNG")
cpp_SetDamageAmount(26184574,-1);
--New Object Definition Script
BASE_26184575 = 26184575;
cpp_AddSubGameObject(BASE,BASE_26184575,-1,4363.003418,1147.000000,0.000000)
cpp_SetGameObjectOrientation(BASE_26184575,-1.570752)

cpp_LinkBitmapToID(BASE_26184575,"./images/CONCRETE.PNG")
cpp_SetDamageAmount(26184575,-1);
--New Object Definition Script
BASE_26184576 = 26184576;
cpp_AddSubGameObject(BASE,BASE_26184576,-1,4500.000000,1220.000000,0.000000)
cpp_SetGameObjectOrientation(BASE_26184576,-1.570752)

cpp_LinkBitmapToID(BASE_26184576,"./images/CONCRETE.PNG")
cpp_SetDamageAmount(26184576,-1);
--New Object Definition Script
AAGUN_26184577 = 26184577;
cpp_AddSubGameObject(AAGUN,AAGUN_26184577,-1,415.000000,799.000000,3.000000)
...
cpp_AddSubGameObject(AAGUN,AAGUN_26184578,-1,1074.000000,798.000000,3.000000)
...
cpp_AddSubGameObject(AAGUN,AAGUN_26184579,-1,1322.000000,801.000000,3.000000)
